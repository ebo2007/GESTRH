    ...
    <div class="col-md-12">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Employés des ARCHIVES DU MAROC</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="box-group" id="accordion">
                    ...
                    foreach ($data as $dvs) {
                        ...
                        <div class="panel box box-primary">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="<?php echo "#clp_".$dvs['sid']?>">
                                        <?php echo $dvs['nom']?>
                                    </a>
                                </h4>
                            </div>
                            <div id="<?php echo "clp_".$dvs['sid']?>" class="panel-collapse collapse">
                                <div class="box-body">
                                    <?php
                                    ...
                                    foreach ($sData as $srv) {
                                        ...
                                        <div class="col-md-6">
                                            <div class="box box-primary  box-solid">
                                                <div class="box-header with-border">
                                                    <h3 class="box-title"><?php echo $srv['nom']?></h3>
                                                </div>
                                                <!-- /.box-header -->
                                                <div class="box-body">
                                                    <ul class="users-list clearfix">
                                                        ...
                                                        foreach ($eData as $emplye) {
                                                            $stre = str_replace("\"", "'", json_encode($emplye, JSON_UNESCAPED_UNICODE));
                                                            ?>
                                                            <li>
                                                                <img src="dist/img/user1-128x128.jpg" alt="<?php echo $emplye['nom']?>">
                                                                <a class="users-list-name" href="#"><?php echo $emplye['nom']?></a>
                                                                <span class="users-list-date"><?php echo $emplye['nom']?></span>
                                                            </li>
                                                            <?php
                                                        }
                                                        ?>
