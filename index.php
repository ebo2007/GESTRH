...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="dist/css/cmpl/font-awesome.min.css">
    <!-- Ionicons -->
    ...
    <!--[if lt IE 9]>
    <script src="dist/css/cmpl/html5shiv.min.js"></script>
    <script src="dist/css/cmpl/respond.min.js"></script>
    <![endif]-->
</head>
<!--
BODY TAG OPTIONS:
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="?page=dashboard.php" class="logo">
            ...
            <span class="logo-lg"><b>Gestion</b> RH</span>
        </a>
